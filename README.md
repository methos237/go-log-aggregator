...
shaped the code is written up in [`docs/decisions/`](docs/decisions/). Stretch goals
that did not make the cut are listed in
[ADR-0001](docs/decisions/ADR-0001-architecture-baseline.md).
...
[`ADR-0008`](docs/decisions/ADR-0008-benchmark-driven-defaults.md). Reproduce a run
...
[`ADR-0002`](docs/decisions/ADR-0002-schema-and-write-path.md) has the reasoning,
including the TimescaleDB behaviours that shaped it, and
[`ADR-0008`](docs/decisions/ADR-0008-benchmark-driven-defaults.md) the measurement
...
[`ADR-0001`](docs/decisions/ADR-0001-architecture-baseline.md) records the rejected

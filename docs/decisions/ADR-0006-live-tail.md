...
The roadmap sketched a JetStream fan-out subject and ring-routed
subscriptions. Both were reconsidered once the pieces were on the table.

## Decisions

### The fan-out is a core NATS publish, not a second stream
...
### Subscriptions are evaluated where the client is
...
### One evaluator, mirroring the planner
...
### A slow client loses records, counted, and never blocks delivery
